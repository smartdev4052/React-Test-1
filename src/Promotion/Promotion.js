  ...
  return (
    <div className="promo-app">
      ...
      {isDate ?
        ...
        <div className="promo-link-div">{promotion.promotion_name} ({promotion.promo_image_url})</div>
      }
      <div className="promo-summary">{promotion.summary}</div>
      {isDate === true &&
        <p className="promo-date">Next Drawing Date: {promotion.drawings[0].drawing_date}</p>
      }
    </div>
  )
}
